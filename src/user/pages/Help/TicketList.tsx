  ...
  return (
    <div className="ticket-list-container bg-white min-h-screen p-6 shadow-lg rounded-lg">
      ...
      <div className="ticket-header flex justify-between items-center mb-6">
        ...
        <button
          className="help-page-btn bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md shadow-md transition"
      ...
      {tickets.length === 0 ? (
        ...
        <ul className="space-y-4">
          {tickets.map((ticket) => (
            <li
              key={ticket.ticketId}
              className="ticket-item bg-purple-100 p-4 rounded-lg shadow-md flex justify-between items-center hover:bg-purple-200 transition"
            >
              <div className="ticket-details">
                ...
                <span
                  className={`ticket-status ml-4 px-2 py-1 rounded-md text-xs font-semibold ${
              ...
              <div className="ticket-actions space-x-2">
                <button
                  className="view-btn bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 rounded-md shadow-md transition"
                  onClick={() => navigate(`/user/ticket-view/${ticket.ticketId}`)}
                >
                  View
                </button>
                <button
                  className="delete-btn bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md shadow-md transition"
