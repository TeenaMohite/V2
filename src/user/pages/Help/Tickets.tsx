...
const TicketsPage = ({ setCurrentPage }) => {
  ...
  useEffect(() => {
    // Fetch tickets from local storage or an API (replace with actual API call)
  ...
  return (
    <div className="tickets-container bg-white shadow-lg rounded-lg p-6 min-h-screen">
      ...
      <button
        className="help-btn bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition"
            ...
            {tickets.length === 0 ? (
              ...
              tickets.map((ticket, index) => (
                ...
                >
                  ...
                  <td className="p-2">{ticket.timestamp}</td>
